...
export default function Card({backgroundImage, title,delay}) {
  ...
  >
    <div className={"w-64 h-40 md:w-64 md:h-56 lg:w-72 lg:h-64 xl:w-96 xl:h-80 bg-cover rounded-xl flex gap-10 justify-center lg:justify-center " + backgroundImage}>
